...
const immmobiliareit = "https://www.immobiliare.it/stanze/Firenze/camere-Firenze.html";
const uniaffiti = "https://www.uniaffitti.it/firenze";
const bakeca = "https://firenze.bakeca.it/annunci/offro-camera/";
const LogementText = () => {
  return (
