...
const forgotPassword = ({navigation}) =>{
    ...
    const resetMail = async () =>{
        try {
            ...
            Alert.alert("envoyé","on vous enverra un mail dans un instant");
               ...
               <ScrollView>
                    ...
                    <View style={styles.button}>
                        <TouchableOpacity
                            ...
                            onPress = {resetMail}
                        >
                            {loading.loadingLogin? <ActivityIndicator size="large" color="white"/> : <Text style={[styles.textSign, {color:'#fff'}]}>Initialisez le mot de passe</Text>}
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </Animatable.View>
