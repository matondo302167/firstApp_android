  ...
  const [_scroll_y] = useState(new Value(0));
    ...
    return(
      <SafeAreaView style={styles.safe_area_view}>
        ...
        />
        <Text style={{color:'#fff',fontSize:20}}>numéro de telephone</Text>
        </Animated.View>
        <Animated.ScrollView
          style={[
            styles.scroll_view,
        ...
        >
          ...
          <Text style={[styles.text_header,{color:'#000',fontSize:20,marginBottom:50}]}>Veuillez de Suivre nos intructions</Text>
            <Text style={styles.text_footer}>Mettez votre numéro de telephone</Text> 
            ...
            <View style={styles.button}>
                  ...
                  onPress = {addNumer}
                >
                {loading.loadingLogin? <ActivityIndicator size="large" color="white"/> : <Text style={[styles.textSign, {color:'#fff'}]}>Enregistre le numéro</Text>}
              </TouchableOpacity>
            </View>
          </View>
